...
def create_new_student(db: Session, student: schemas.CreateStudent) -> models.Student:
    new_student = models.Student(
        ...
        facial_encoding=student.facial_encoding
    )
    db.add(new_student)
    db.commit()
...
def create_new_lecturer(db: Session, lecturer: schemas.CreateLecturer) -> models.Lecturer:
